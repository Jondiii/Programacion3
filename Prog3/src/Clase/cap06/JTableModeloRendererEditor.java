...
public class JTableModeloRendererEditor {
	...
	static Object[][] datos = { //El elemento 0 0 sería "Andoni", el 0 1 false, el 1 0 "Itxaso"...
	...
	public static void main(String[] args) {
		...
		jTable = new JTable( datos, cabeceras ); //datos es un array bidimensional, hace una fila con todos los datos de cada posición.
		...
		mTable.setValueAt( "Alberto", 0, 0 );  // Cambiar valores... //TODO si no cambia na
		...
		jTable.setDefaultRenderer( Double.class, new DefaultTableCellRenderer() {  // Pone el renderer para todos los valores que sean Double (puntuación)
			...
			public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
				...
				Component normal = super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column); // TODO super?¿
		...
		jTable.setDefaultEditor( Integer.class, new TableCellEditor() {
			SpinnerNumberModel mSpinner = new SpinnerNumberModel( 0, 0, 120, 1 ); //Esto crea un rango de valores de 0 a 120 que sube/baja de 1 en 1 y que empieza en 0.
			JSpinner spinner = new JSpinner( mSpinner ); //El JSpinner es como el spinner model ese pero visual.
			@Override
			public boolean stopCellEditing() { // Llamado cuando se acaba la edición
				ChangeEvent ce = new ChangeEvent(this);
				for (int i=0; i<lListeners.size(); i++) lListeners.get(i).editingStopped( ce ); //TODO qué hace esto. Esto y todo lo de abajo.
				return true;
			}
			@Override
